...
export const fairTicketAbi = parseAbi([
  ...
  "function activeListings() view returns (uint256[] tokenIds, address[] sellers, uint96[] prices)",
...
const DEFAULT_TESTNET_ADDRESS = "0x5d91c595b263469059c9494a7c40600d4a061146";
const rawAddress = process.env.NEXT_PUBLIC_FAIR_TICKET_ADDRESS || DEFAULT_TESTNET_ADDRESS;
